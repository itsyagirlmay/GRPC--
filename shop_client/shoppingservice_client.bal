...
public function main() returns error? {
    ...
    while repeat {
        ...
        if roleChoice == "1" {
            ...
            currentUserId = "adminUser"; // Set a default ID for the admin
        } else if roleChoice == "2" {
            currentUserType = "customer";
            currentUserId = "customerUser"; // Set a default ID for the customer
        } else {
        ...
        if option == "1" && currentUserType == "admin" {
            ...
            io:println("You are not authorized to perform this action.");
        }
